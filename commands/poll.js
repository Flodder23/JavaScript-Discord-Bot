...
class PollCommand extends Command {
	...
	async exec(message, args) {
		...
		if (3 <= options.length <= 26) {
			...
			return message.reply("Something went wrong - options should be seperated by a semi-colon, like this: `question; option 1; option 2; option 3` etc.")
		}
	}
}
